...
{
	protected:
		//int* m_OnShootFunction;	//pointer to a function that should be called whenever the player shoots.
		//int* m_OnHitFunction;	//pointer to a function that should be called whenever the player is hit.
